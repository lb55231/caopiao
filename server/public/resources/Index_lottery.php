...
<img src="__ROOT__/resources/images/f1k3.png" style="width: 30px; height: 30px;">
                  ...
                  <img src="__ROOT__/resources/images/bjk3.png" style="width:60px; height: 60px;">
                </if>
                    <if condition="$cp[name] eq f5k3">
                      <img src="__ROOT__/resources/images/f5k3.png" style="width:60px; height: 60px;">
                    </if>
                    <if condition="$cp[name] eq ahk3">
                      <img src="__ROOT__/resources/images/ahk3.png" style="width:60px; height: 60px;">
                    </if>
                    <if condition="$cp[name] eq hebk3">
                      <img src="__ROOT__/resources/images/hebk3.png" style="width:60px; height: 60px;">
                    </if>

                    <if condition="$cp[name] eq jlk3">
                      <img src="__ROOT__/resources/images/jlk3.png" style="width:60px; height: 60px;">
                    </if>

                    <if condition="$cp[name] eq gxk3">
                      <img src="__ROOT__/resources/images/gxk3.png" style="width:60px; height: 60px;">
                    </if>
                    <if condition="$cp[name] eq jxk3">
                      <img src="__ROOT__/resources/images/JXK3.png" style="width:60px; height: 60px;">
                    </if>
                    <if condition="$cp[name] eq jsk3">
                      <img src="__ROOT__/resources/images/jsk3.png" style="width:60px; height: 60px;">
                    </if>
                  </eq>
								</div>
								<div class="media-body">
						...
						<li class="k3_project">
							<div class="media">
								<div class="media-left">
									...
									<if condition="$cp['typeid'] eq 'pk10'">
										<i class="icon-pkshi iconfont" style="color:#f22751" ></i>
									</if>
									<if condition="$cp['typeid'] eq 'keno'">
