$(function () {
    ...
    function tabGameInit() {
        ...
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从冠、亚、季、四、五、六、七、八、九、十任意位置上任意选择一个或一个以上号码，返佣 <em style="color:red;">' + rates.maxjj + '</em>元');
    ...
    $('.bet_filter_box').on('click', '.bet_options', function () {
        ...
        switch (_thisType) {
            ...
            case 'bjpk10qian3ds':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('手动输入号码，输入3个号码组成一注，返佣 <em style="color:red;">' + rates.maxjj + '</em>元');
                danshiNumberL = 2;
                danshiGame();
                break;
            case 'bjpk10qian3':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从各名次中各选择1个不重复的号码组成一注，返佣  <em style="color:red;">' + rates.maxjj + '</em>元');
            ...
            case 'bjpk10qian5ds':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('手动输入号码，输入5个号码组成一注，返佣 <em style="color:red;">' + rates.maxjj + '</em>元');
                danshiNumberL = 2;
                danshiGame();
                break;
            case 'bjpk10qian4':
            ...
            case 'bjpk10qian4ds':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('手动输入号码，输入4个号码组成一注，返佣 <em style="color:red;">' + rates.maxjj + '</em>元');
                danshiNumberL = 2;
                danshiGame();
                break;
            case 'bjpk10qian2':
            ...
            case 'bjpk10qian2ds':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('手动输入号码，输入2个号码组成一注，返佣  <em style="color:red;">' + rates.maxjj + '</em>元');
                danshiNumberL = 2;
                danshiGame();
                break;
            case 'cqgj':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('选择1个号码组成一注，返佣 <em style="color:red;">' + rates.maxjj + '</em>元');
