		...
		<div class="pull-right vip_info_pan">
			...
			<div class="vip_info_content betRecord_main">
				<div class="betRecord_top">
					<strong>今日概况</strong>
					<span>下单金额：<em>{$touzhujine}元</em></span>
					<span>收益金额：<em>{$allokamount}元</em></span>
				...
				<div class="betRecord_tab clearfix">
					<div class="category pull-left">
						...
						<div class="form-group">
							<select name="lotteryId" id="lottery_code" onchange="chaxun();" class="form-control" id="">
								<option value="0">全部商户</option> {$cp[name]} 
					...
					<span class="bet_status pull-left" id="status-box">
						...
						<span class="bet_common_bor a_item  <if condition="$Think.get.a_item eq 2">active</if>" value="2""  onclick="chaxun(null,'2');">已匹配订单</span>
						<span class="bet_common_bor a_item  <if condition="$Think.get.a_item eq 3">active</if>" value="3""  onclick="chaxun(null,'3');">未匹配订单</span>
						<span class="bet_common_bor a_item  <if condition="$Think.get.a_item eq 4">active</if>" value="4""  onclick="chaxun(null,'4');">待匹配</span>
					</div>
							...
							<tr>
								...
								<td>
									<if condition="$vo[isdraw] eq 0">
										...
										<span style="color:red">已匹配订单</span>
										<elseif  condition="$vo[isdraw] eq -1" />
										<span style="color:green">未匹配订单</span>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">下单内容</h4>
            </div>
