            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    ...
                    if (theOpenNumb != "") {
                        ...
                        var theOpenNumberLength = theOpenNumb.length; //匹配单号的长度
                    ...
                    if (theBetting_num != "") {
                        ...
                        var theBetting_numLength = theBetting_num.length; //匹配单号的长度
                    ...
                    if (_TrData[i].winning_state == "未匹配订单") {
                        strVar += " <td style='color:green'>" + _TrData[i].winning_state + "</td>";
                    } else if (_TrData[i].winning_state == "已匹配订单") {
        ...
        function Account_cusmagListFn(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1" && data.Data != null) {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    ...
                    strVar += " <td>";
                    strVar += "     <a  class='alink record' title='下单记录' href='" + _TrData[i].bettingURL + "' childUid ='" + _TrData[i].user_id + "' ><i class='iconfont'>记录</i></a>";
        ...
        function Invest_zh_recordslist(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    ...
                    strVar += " <td>" + _TrData[i].lottery_name + "</td>"; //商品名称
        ...
        function table_showBaoBiaolist(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                for (var a = 0 ; a < _TrData.length ; a++) {
                    ...
                    var winningMoney = _TrData[a].winningMoney //收益金额
