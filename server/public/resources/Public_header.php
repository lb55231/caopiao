...
<header class="header" style="height:30px;">
    ...
    <li class="user_login_info4">
        <!-- <a href="{:U('Account/quickRecharge')}" ocnclick="javascript:alert('请联系订单员获取购単方式')">够单</a> -->
        <a onclick="javascript:alert('请联系订单员获取购単方式')">购单</a>
    </li>
    <li class="user_login_info5">
        <a href="{:U('Account/withdrawals')}">回款</a>
    </li>
...
<div class="header head8">
    <div class="nav">
        <div class="container fix">
             ...
             <img src="{:GetVar('logo')}" style="height: 65px;">
            <ul class="navItem fix flr" style="position: relative;">
                ...
                <li class=""><a href="{:U('Index/lottery')}">商家列表</a></li>
                <!----><!--
                <li class=""><a href="{:U('Activity/index')}">活动中心</a></li>
                <!---->--><!--
                <li class=""><a href="{:U('Index/mobile')}">手机版</a></li>
                <!---->-->
