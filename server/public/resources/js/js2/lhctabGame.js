$(function () {
    ...
    $('.bet_filter_box').on('click', '.bet_options', function () {
        ...
        switch (_thisType) {
            ...
            case 'tmlm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号最后一位为特码。大于或等于25为特码大，小于或等于24为特码小；奇数为单，偶数为双；特码两个数相加后得数，奇数为合单，偶数为合双，小于等于6为合小，大于6为合大；尾大尾小即看特码个位数值，小于等于4为小，大于4为大；特码为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zmrx':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码在匹配单号前六位中存在，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm1t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第一位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm1lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第一位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zm2t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第二位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm2lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第二位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zm3t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第三位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm3lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第三位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zm4t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第四位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm4lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第四位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zm5t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第五位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm5lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第五位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'zm6t':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从1-49中任选1个或多个号码，每个号码为一注，所选号码与匹配单号第六位相同，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'zm6lm':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('匹配单号第六位，大于或等于25为大，小于或等于24为小；奇数为单，偶数为双；和单和双为两个数相加后得数的单双；尾大尾小即看个位数值，小于等于4为小，大于4为大；为49时为和，不算任何大小单双，但算波色。');
                lhclmgameNumber(lhc_tmlm_content, rates.rate);
                break;
            case 'lm3qz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择三个号码，每三个号码为一组合，若三个号码都是匹配单号之正码，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'lm3z2':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择三个号码，每三个号码为一组合，若其中至少有两个是匹配单号中的正码，即为中奖。若中两码，叫三中二之中二;若三码全中，叫三中二之中三。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['中二', '中三'];
            ...
            case 'lm2zt':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择两个号码，每二个号码为一组合，二个号码都是匹配单号（含特码），即为中奖。若两个都是正码，叫二中特之二中。若选号中包含特码，叫二中特之中特。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['二中', '中特'];
                addMoneyInfo(caizhong, rates.rate);
                lhcgameNumber(lhc_tmzx_num);
                break;
            ...
            case 'sx1x':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从十二生肖中任选1个或多个，每个生肖为一注，匹配单号（含特码）中含有投注所属生肖，即为中奖。');
                lhclmgameNumber(lhc_sxtx_content, rates.rate);
                break;
            case 'sx2xl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择两个生肖，每二个生肖为一组合，匹配单号（含特码）中含有投注所属全部生肖，即为中奖。 <span class="moneyInfo">返佣详情</span>');
            ...
            case 'sx3xl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择三个生肖，每三个生肖为一组合，匹配单号（含特码）中含有投注所属全部生肖，即为中奖。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['含本命', '不含本命'];
                addMoneyInfo(caizhong, rates.rate);
                lhclmgameNumber(lhc_sxtx_content, rates.rate);
                break;
            case 'sx4xl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择四个生肖，每四个生肖为一组合，匹配单号（含特码）中含有投注所属全部生肖，即为中奖。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['含本命', '不含本命'];
                addMoneyInfo(caizhong, rates.rate);
                lhclmgameNumber(lhc_sxtx_content, rates.rate);
                break;
            ...
            case 'ws2wl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择两个尾数，每两个尾数为一组合，匹配单号（含特码）中含有投注对应全部尾数，即为中奖。 <span class="moneyInfo">返佣详情</span>');
            ...
            case 'ws3wl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择三个尾数，每三个尾数为一组合，匹配单号（含特码）中含有投注对应全部尾数，即为中奖。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['含0尾', '不含0尾'];
                addMoneyInfo(caizhong, rates.rate);
                lhclmgameNumber(lhc_wstw_content1, rates.rate);
                break;
            case 'ws4wl':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择四个尾数，每四个尾数为一组合，匹配单号（含特码）中含有投注对应全部尾数，即为中奖。 <span class="moneyInfo">返佣详情</span>');
                var caizhong = ['含0尾', '不含0尾'];
                addMoneyInfo(caizhong, rates.rate);
                lhclmgameNumber(lhc_wstw_content1, rates.rate);
                break;
            case 'bz5bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择五个号码，每五个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'bz6bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择六个号码，每六个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'bz7bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择七个号码，每七个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'bz8bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择八个号码，每八个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'bz9bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择九个号码，每九个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
            case 'bz10bz':
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('至少选择十个号码，每十个号码为一注，所有号码均未在匹配单号中出现，即为中奖。 赔率 <em style="color:red;">' + rates.rate + '</em>元');
                lhcgameNumber(lhc_tmzx_num);
                break;
        }
