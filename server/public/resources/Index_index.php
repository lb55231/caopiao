                            ...
                            <switch name="cp.typeid">
                                <case value="k3">
                                    <a href="__ROOT__/Game.k3?code={$cp[name]}" title="{$cp[ftitle]}">
                                       <if condition="$cp.name eq f1k3">

<img src="__ROOT__/resources/images/f1k3.png" style="width: 30px; height: 30px;">
                                </IF>
								<if condition="$cp[name] eq bjk3">
                                     <img src="__ROOT__/resources/images/bjk3.png" style="width:30px; height: 30px;">
                                </if>
								<if condition="$cp[name] eq f5k3">
                                     <img src="__ROOT__/resources/images/f5k3.png" style="width: 30px; height: 30px;">
                                </if>
								<if condition="$cp[name] eq ahk3">
                                     <img src="__ROOT__/resources/images/ahk3.png" style="width: 30px; height: 30px;">
                                </if><if condition="$cp[name] eq hebk3">
                                     <img src="__ROOT__/resources/images/hebk3.png" style="width: 30px; height: 30px;">
                                </if><if condition="$cp[name] eq jlk3">
                                     <img src="__ROOT__/resources/images/jlk3.png" style="width: 30px; height: 30px;">
                                </if><if condition="$cp[name] eq gxk3">
                                     <img src="__ROOT__/resources/images/gxk3.png" style="width: 30px; height: 30px;">
                                </if>
								<if condition="$cp[name] eq jxk3">
                                     <img src="__ROOT__/resources/images/jxk3.png" style="width: 30px; height: 30px;">
                                </if>
								
								<if condition="$cp[name] eq jsk3">
                                     <img src="__ROOT__/resources/images/jsk3.png" style="width: 30px; height: 30px;">
                                </if>
                                </case>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <a href="{:U('Activity/index')}"><img src="__IMG__/bannerqi2.jpg" alt=""></a>
                            </div>
                            
                           <div class="item">
                                <a href="{:U('Activity/index')}"><img src="__IMG__/bannerqi3.jpg" alt=""></a>
                            </div>
                            <div class="item">
                                <a href="{:U('Activity/index')}"><img src="__IMG__/bannerqi4.jpg" alt=""></a>
                            </div>
                            <!--  <div class="item">
                    ...
                    <div class="tab_menu">
                        <ul class="tab_menu_box row margin_0">
                            <volist name="bncaipiao" id="value" key="key">
                                ...
                                <eq name="value.name" value="f1k3">
                                    <li class="col-xs-4">{$value['title']}</li>
                                </eq>
                                <eq name="value.name" value="jlk3">
                                    <li class="col-xs-4">{$value['title']}</li>
                                </eq>
                            </volist>
                                     ...
                                     <eq name="value[typeid]" value="k3">
                                        <li style="display:block;">
                                            ...
                                            <p style="font-size: 18px;">
                                                <if condition="$value['daxiao'] == '大'">
                                                    精品
                                                    <else/>
                                                    普货
                                                </if>
                                                &nbsp;
                                                <if condition="$value['danshuang'] == '单'">
                                                    单/件
                                                    <else/>
                                                    双/件
                                                </if>
                                            ...
                                            <p class="words">
                                                <span>当前第<em class="expect_{$value['name']}">{$value['expect']}</em>单</span>
                                                <span>匹配订单截止：<em class="times_{$value['name']}"></em></span>
                                            ...
                                            <p><div onclick="location.href='__ROOT__/Game.k3?code={$value[name]}'" style="display: inline-block;line-height: 30px;color: #fff!important;padding: 0 15px;border-radius: 3px;font-size: 14px;min-width: 55px;text-align: center;cursor: pointer;background: #e4393c;margin: 10px 0;">立即购单</div></p>
                                        </li>
                                    </eq>
                                </volist>
                            </ul>
                ...
                <div class="login clearfix">
                    ...
                    <div class="login-box">
                        ...
                        <div class="help-tab-box">
                            ...
                            <ul class="help-ul">
                                <li>
                                    <a href="{:U('News/lists',array('catid'=>33))}" target="_blank">如何注册会员？</a>
                                </li>
                                <li>
...
<script>
function checklotterytimes(shortName) {
    setTimeout(function() {
        $.ajax({
            url: '/Index.lotterytimes.do?shortName=' + shortName,
            type: 'GET',
            dataType: 'json',
            success: function (json) {
                ...
                for(var k in json) {
                    ...
                    countdownTime(json[k].remainTime, k);
                    $(".expect_" + k).text(json[k].currFullExpect);
                }
            }
        });
    }, 1000);
...
var CDTime = [];
function countdownTime(leftSec, shortName) {
    var h, m, s, t;
    var h1, m1, s1;
    var h2, m2, s2;
    if (CDTime[shortName]) {
        clearInterval(CDTime[shortName]);
    }
    ...
    if (t > 0) {
		...
		$(".times_" + shortName).text(h1+h2 + ':' + m1+m2 + ':' + s1+s2);
        CDTime[shortName] = setInterval(function() {
