...
<div id="dataWrap">
    ...
    <div class="selectWay">
        ...
        <div class="l ml-20">
        <span>选择商品：<select name="selectDate" id="selectlettery" class="text-muted" onChange="MM_jumpMenu('window',this,0)"></select>&nbsp;&nbsp;</span>
        </div>
    </div>
...
<table class="dataTable" id="chartsTable">
    <thead>
        <tr class="text-c">
            ...
            <th colspan="20" rowspan="2">匹配单号</th>
            <th colspan="80" >匹配单号分布</th>
        </tr>
        <tr class="">
            <th>1</th>
            <th>2</th>
