						...
						<div class="m-m-cen ym-grid">
							<div class="m-m-subnav tab">
								<ul class="level2-nav tabHd">
									...
									<li data-tabid="lotteryreport">商户报表</li>
								...
								<div class="tabBd">
									<div class="tb-imte cur" style="display: block;">
										<table class="mem-biao" id="userBets">
												...
												<tr>
													<th colspan="10">
														...
														<select class="state">
															...
															<option value="-1">未匹配订单</option>
															<option value="1">已匹配订单</option>
                                            ...
                                            返佣收入：<b way-data="userbets.fanjiangtotal">0.00</b>
...
<option value="amount">现金账户</option><option value="xima">洗码账户</option><option value="point">积分账户</option>
												...
												<tbody>
											<tr><th>订单号</th><th>商品</th><th>期号</th><th>玩法</th><th>模式</th><th>金额</th><th>倍数</th><th>返佣</th><th>状态</th></tr>
												</tbody>
											</table>
									</div>
									<div class="tb-imte" style="display: none;">
