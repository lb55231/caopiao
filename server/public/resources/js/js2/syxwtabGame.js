$(function () {
  ...
  function tabGameInit(){
    ...
    $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择3个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序一致，即为中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
  ...
  $('.bet_filter_box').on('click','.bet_options',function (){
    ...
    switch(_thisType){
      ...
      case 'x5qsds':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('手动输入3个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序一致，即为中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5qszx':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择3个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序不限，即为中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5qszx,11,1);
        break;
      case 'x5qszxds':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('手动输入3个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序不限，即为中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5qsdt':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择3个以上号码进行投注，每注需至少包括1个胆码及2个拖码。只要当期的前三位匹配单号中有3个包含所选号码（每注包含3个号码），即为中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5qsdt,11,1);
        break;
      case 'x5qefs':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择2个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序一致，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5qefs,11,1);
        break;
      case 'x5qeds':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('手动输入2个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序一致，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5qezx':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择2个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序不限，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5qezx,11,1);
        break;
      case 'x5qezxds':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('手动输入2个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序不限，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5qedt':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择2个以上号码进行投注，每注需至少包括1个胆码及1个拖码。只要当期的前二位匹配单号中有2个包含所选号码（每注包含2个号码），即为中奖，返佣   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5qedt,11,1);
        break;
      case 'x5bdwqs':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择1个号码，每注由1个号码组成，只要当期顺序摇出的第一位、第二位、第三位匹配单号中包含所选号码，返佣   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5bdwqs,11,1);
        break;
      case 'x5dwd':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从第一位、第二位、第三位任意1个位置或多个位置上选择1个号码，所选号码与相同位置上的匹配单号一致，返佣   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5dwd,11,1);
        break;
      case 'x5dds':

        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从6种单双个数组合中选择1种组合，当匹配单号的单双个数与所选单双组合一致   <span class="moneyInfo">返佣详情</span>');
        addMoneyInfo(syxw_x5dds,rates.maxjj);
        gameNumberQw(syxw_x5dds);
        break;
      case 'x5czw':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从3-9中选择1个号码进行购买，所选号码与5个匹配单号按照大小顺序排列后的第3个号码相同，即为中奖   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5czw,9,3);
        break;
      case 'x5rx1z1':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择1个号码进行购买，当期的5个匹配单号中包含所选号码，返佣   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx1z1,11,1);
        break;
      case 'x5rx2z2':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择2个号码进行购买，只要当期的5个匹配单号中包含所选号，返佣   <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx2z2,11,1);
        break;
      case 'x5rx3z3':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择3个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx3z3,11,1);
        break;
      case 'x5rx4z4':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择4个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx4z4,11,1);
        break;
      case 'x5rx5z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择5个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx5z5,11,1);
        break;
      case 'x5rx6z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择6个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx6z5,11,1);
        break;
      case 'x5rx7z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择7个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx7z5,11,1);
        break;
      case 'x5rx8z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中选择8个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_x5rx8z5,11,1);
        break;
      case 'x5rxds1z1':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入1个号码进行购买，只要当期的5个匹配单号中包含所选号码，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break; 
      case 'x5rxds2z2':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入2个号码进行购买，只要当期的5个匹配单号中包含所选号码，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break; 
      case 'x5rxds3z3':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入3个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break; 
      case 'x5rxds4z4':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入4个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5rxds5z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入5个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5rxds6z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入6个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5rxds7z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入7个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5rxds8z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11中手动输入8个号码进行购买，只要当期的5个匹配单号中包含所选号码，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        danshiNumberL = 2;
        danshiGame();
        break;
      case 'x5dt2z2':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择2个以上号码进行投注，每注需至少包括1个胆码及1个拖码。只要当期的5个匹配单号中有2个包含所选号码（每注包含2个号码），即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt3z3':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择3个以上号码进行投注，每注需至少包括1个胆码及2个拖码。只要当期的5个匹配单号中有3个包含所选号码（每注包含3个号码），即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt4z4':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择4个以上号码进行投注，每注需至少包括1个胆码及3个拖码。只要当期的5个匹配单号中有4个包含所选号码（每注包含4个号码），即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt5z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择5个以上号码进行投注，每注需至少包括1个胆码及4个拖码。只要所选的每注5个号码和当期的5个匹配单号全部相同，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt6z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择6个以上号码进行投注，每注需至少包括1个胆码及5个拖码。只要所选的每注6个号码当中，有5个和当期的5个匹配单号全部相同，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt7z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择7个以上号码进行投注，每注需至少包括1个胆码及6个拖码。只要所选的每注7个号码当中，有5个和当期的5个匹配单号全部相同，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
      case 'x5dt8z5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-11共11个号码中至少选择8个以上号码进行投注，每注需至少包括1个胆码及7个拖码。只要所选的每注8个号码当中，有5个和当期的5个匹配单号全部相同，即为中奖，返佣  <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(syxw_rxtd_x5dt2z2,11,1);
        break;
    }
  })
