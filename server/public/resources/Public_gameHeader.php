...
<header class="header" style="height:40px;line-height:40px;">
    <div class="container claerfix">
        ...
        <div class="pull-left backLeft" style="color:#fff;">
            ...
            |
            <a href="javascript:void(0);" class="allLottery" style="color:#fff;">全部商户</a>
            ...
            <div class="pull-right user_login_info">
                <ul>
                    <li class="user_login_info1">
                        <a  href="{:U('Member/index')}" style="color:#000;" class="user_header" data-html="true" class="user_header" data-container="body" data-toggle="popover" data-placement="bottom"data-content='<div class="ceng"><div class="media"><div class="media-left"><a href="{:U('Member/index')}"><img src="__ROOT__{$userinfo.face}" alt="" class="media-boject img-circle"></a><p>{$userinfo.username}</p></div><div class="media-body" style="padding-bottom:10px;">
