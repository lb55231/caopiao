...
export const updateMemberGroup = (id, data) => request.put(`/membergroup/update/${id}`, data)
export const deleteMemberGroup = (id) => request.delete(`/membergroup/delete/${id}`)
export const toggleMemberGroupStatus = (id, status) => 
  request.put(`/membergroup/toggle_status/${id}`, { status })

// 会员管理
export const getMemberList = (params) => request.get('/admin/member/list', { params })
export const updateMember = (id, data) => request.put(`/member/update/${id}`, data)
export const toggleMemberLock = (id) => request.put(`/member/toggle_lock/${id}`)
...
export const deleteMember = (id) => request.delete(`/member/delete/${id}`)
export const kickOutMember = (id) => request.post(`/member/kickout/${id}`)
...
export const deleteAgentLink = (id) => request.delete(`/agent/link/delete/${id}`)
