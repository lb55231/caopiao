	...
	<div id="J_m_nav">
    	<div class="container">
            ...
            <div class="r top-loin">
            	<div class="login-no">
                尊敬的玩家您好！欢迎来到商户平台，请先<a class="c-green" href="{:U('Public/login')}">登录</a>，或用<a class="c-green sjxz" href="__ROOT__/">手机登录</a>&nbsp;&nbsp;[&nbsp;<a class="c-red" href="{:U('Public/register')}">免费注册</a>&nbsp;]
                </div>
...
<section id="wrap" class="container wapper">
	<section class="wapp_top">
        ...
        <div class="wapp_r r b1">
                    ...
                    <div class="notice">
                        <div class="tt bbt"><i class="curr">商户公告</i></div>
    ...
    <section>
    	<div class="allcptitle mt-20"><span class="tit">所有商品</span></div>
        <div class="allcplist">
        	<ul class="cpitem"></ul>
        </div>
    </section>
