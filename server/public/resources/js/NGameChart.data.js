...
$(function () {
    ...
    if ($("#select_lottery").size() > 0) {
        var letterycode = $("#select_lottery").attr("value"); //获取商品
        ...
        //        TendChart_html += "<h3 class=\"select-title\">商品：" + _theSelectStrings + "<\/h3>";
...
function InitTenderCharts(data, initsTypeVal, letterycode, count) {
    ...
    var SSC_DataOptio = {
        ...
        speciesVal: letterycode, //商户种类，重庆时时彩 
        data: {},
        Chart_Container: "J-chart-area", //图表容器在哪   
        Times: count, //页面期数，是多少期
        TypeVal: TypeVal  //商户种类，重庆时时彩  ["五星|wuxing"，"五星综合|zonghe"，“四星\sixing”，“前三/qiansan”，“中三/zhongsan”，“后三/housan”，“前二|qianer”，“后二/houer” ]
    };
