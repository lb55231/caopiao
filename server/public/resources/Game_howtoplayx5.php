	...
	<div class="main">
		<div class="how">
			...
			<div class="how_content">
				<p>{$caipiao['title']}：由中国福利商户发行管理中心组织销售、{$caipiao['title']|mb_substr=###,0,6}<eq name="caipiao['title']" value="上海11选5">市<else />省</eq>福利商户发行中心承销；</p>
				<p>开奖时间：每天早上{$caipiao['firsttime']}分至晚上{$caipiao['endtime']}； 全天{$caipiao['qishu']}期、每10分钟1期；</p>
				<p>匹配单号：从01-11共11个号码中任选1-8个号码进行投注，每期开出5个号码为中奖号码，竞猜5位匹配单号的全部或部分号码。投注方式灵活，开奖频次高，全面满足不同彩民的投注需要；</p>
			</div>
		</div>
		<div class="play">
