$(function () {
  ...
  function tabGameInit(){
    ...
    $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-80中选择1个号码组成一注，当期开奖结果的20个号码中包含所选号码，即可中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
  ...
  $('.bet_filter_box').on('click','.bet_options',function (){
    ...
    switch(_thisType){
      ...
      case 'bjkl8rx2':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从01-80中选择2-8个号码，当期开奖结果的20个号码中包含所选号码中的两个，即可中奖，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
        gameNumber(kl8_bjkl8rx1,80,1);
        break;
      case 'bjkl8rx3':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从01-80中选择3-8个号码，当期开奖结果的20个号码中包含所选号码中的三个，即可中奖。 <span class="moneyInfo">返佣详情</span>');
        var caizhong3 = ['3','2'];
      ...
      case 'bjkl8rx4':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从01-80中选择4-8个号码，当期开奖结果的20个号码中包含所选号码中的四个，即可中奖。 <span class="moneyInfo">返佣详情</span>');
        var caizhong4 = ['4','3','2'];
      ...
      case 'bjkl8rx5':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从01-80中选择5-8个号码，当期开奖结果的20个号码中包含所选号码中的五个，即可中奖。 <span class="moneyInfo">返佣详情</span>');
        var caizhong5 = ['5','4','3'];
      ...
      case 'bjkl8rx6':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从01-80中选择6-8个号码，当期开奖结果的20个号码中包含所选号码中的六个，即可中奖。 <span class="moneyInfo">返佣详情</span>');
      ...
      case 'bjkl8rx7':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('从01-80中选择7-8个号码，当期开奖结果的20个号码中包含所选号码中的七个，即可中奖。 <span class="moneyInfo">返佣详情</span>');
      ...
      case 'bjkl8sxp':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('选择20个匹配单号中包含“上盘(01-40)”与“下盘(41-80)”号码个数多少关系。 <span class="moneyInfo">返佣详情</span>');
        var caizhongsx = ['中','上下'];
      ...
      case 'bjkl8jop':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('选择20个匹配单号中包含“奇·偶”号码个数多少关系。  <span class="moneyInfo">返佣详情</span>');
        var caizhongqo = ['和','奇偶'];
      ...
      case 'bjkl8dxds':
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
            .html('选择20个匹配单号总和值的“大小单双”属性组合(和值<=810为小,>810为大)，返佣 <em style="color:red;">'+rates.maxjj+'</em>元');
